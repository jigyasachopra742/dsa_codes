...
public:
    ...
    void oddEven(){
        ...
        //remove first add last //order remains the same
        ...
        while(this->size>0)
        {
            ...
            this->removeFirst(); //remove first from ll
            
            if(val%2==0) //if val is even
            {
                even.addLast(val); //add last in even ll
            }
            else
            {
                odd.addLast(val); //add last in ll
            }
        }
        
        if(even.size == 0) //but odd list is still there
        {
            this->head = odd.head;
            this->tail = odd.head;
            this->size = odd.size;
