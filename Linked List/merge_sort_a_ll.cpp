...
linkedlist mergeSort(Node* head, Node* tail) 
{
    ...
    {
       linkedlist temp; //since return type of function is linkedlist
   ...
   /* //FINDING MIDDLE OF THE LINKED LIST
    ...
    ans = slow->data; //return the middle data */
    //we are sorting linked lists by dividing hence 1st 2 linked lists mai mergesort kara call 
    linkedlist res1 = mergeSort(head, ans); //head to mid
    linkedlist res2 = mergeSort(ans->next, tail); //fir mid ke aage ka
 
    linkedlist resf = mergeTwoSortedLists(res1, res2); //combining and sorting both
